...
* o pacote xadrez, onde a implementação de peças e tabuleiros é feita para um jogo de xadrez. aqui é declarado os movimentos de cada 
peça, e as regras de negocio são desenhadas em conformidade com as regras do xadrez.
* o pacote aplicação, com as classes necessárias para rodar o jogo no gitBash.